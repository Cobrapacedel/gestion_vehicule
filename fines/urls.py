...
urlpatterns = [
   ...
   # path('pay/<int:fine_id>/', views.pay_fine, name='pay_fine'),
    ...
    path('pay/<int:fine_id>/', views.fine_pay, name='fine_pay_form'),
    path('deleted/export/csv/', views.export_deleted_fines_csv, name='export_deleted_fines_csv'),
    path("htmx/owner/", views.htmx_owner_lookup, name="htmx_owner_lookup"),
    path("htmx/driver/", views.htmx_driver_lookup, name="htmx_driver_lookup"),
